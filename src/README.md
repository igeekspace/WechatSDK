...
主要是在https://github.com/dodgepudding/wechat-php-sdk的基础上做修改,但是原作者应该是因为一些原因,已经很久没维护了,所有自己建个仓库,继续完善
本人主要是维护自己用到的类,可能暂时不是很完善,大家使用过程中有什么问题,可以通过github的Issue跟我沟通
